  ...
  return (
    <div className='w-full contact-form mx-auto relative'>
        <form>
            ...
            <div className='mb-5'>
              <input type="text"  className='placeholder:text-slate-400 focus:ring-2 focus:ring-[#5e52e8] py-2 px-4 rounded-2xl border-0 w-full  focus:border-1 focus:border-color[#5e52e8]' placeholder='081234 56789' name="name" required />
            </div>
