  ...
  return (
    <div className='w-full contact-form'>
        <form>
            ...
            <div className='mb-3'>
              <input type="text" className='p-2 rounded w-full' placeholder='First name' name="name" required />
            </div>
            <div className='mb-3'>
              <input type="text" className='p-2 rounded w-full' placeholder='Last name' name="name" required />
            </div>

            <label className='text-[#000] font-bold'>Email <span className='text-[#FF0000]'>*</span></label>
            <div className='mb-3'>
              <input type="email" className='p-2 rounded w-full' placeholder='name@example.com' name="name" required />
            </div>
            ...
            <div className='mb-3'>
              <textarea  className='p-2 rounded w-full' rows={5} placeholder='' name="name" required />
            </div>
